...
func (x *FibonacciReqest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FibonacciReqest) ProtoMessage() {}

func (x *FibonacciReqest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_main_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FibonacciReqest.ProtoReflect.Descriptor instead.
func (*FibonacciReqest) Descriptor() ([]byte, []int) {
	return file_proto_main_proto_rawDescGZIP(), []int{2}
}

func (x *FibonacciReqest) GetN() int32 {
	if x != nil {
		return x.N
	}
	return 0
...
const file_proto_main_proto_rawDesc = "" +
	...
	"\x03sum\x18\x01 \x01(\x05R\x03sum\"\x1f\n" +
	"\x0fFibonacciReqest\x12\f\n" +
	"\x01n\x18\x01 \x01(\x05R\x01n\"+\n" +
	"\x11FibonacciResponse\x12\x16\n" +
	"\x06number\x18\x01 \x01(\x05R\x06number2\x97\x01\n" +
	"\n" +
	"Calculator\x126\n" +
	"\x03Add\x12\x16.calculator.AddRequest\x1a\x17.calculator.AddResponse\x12Q\n" +
	"\x11GenerateFibonacci\x12\x1b.calculator.FibonacciReqest\x1a\x1d.calculator.FibonacciResponse0\x01B\x13Z\x11/proto/gen;mainpbb\x06proto3"
...
var file_proto_main_proto_goTypes = []any{
	...
	(*FibonacciReqest)(nil),   // 2: calculator.FibonacciReqest
...
var file_proto_main_proto_depIdxs = []int32{
	...
	2, // 1: calculator.Calculator.GenerateFibonacci:input_type -> calculator.FibonacciReqest
