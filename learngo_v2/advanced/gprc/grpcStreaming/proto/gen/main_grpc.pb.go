...
type CalculatorClient interface {
	...
	GenerateFibonacci(ctx context.Context, in *FibonacciReqest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FibonacciResponse], error)
...
func (c *calculatorClient) GenerateFibonacci(ctx context.Context, in *FibonacciReqest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FibonacciResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Calculator_ServiceDesc.Streams[0], Calculator_GenerateFibonacci_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[FibonacciReqest, FibonacciResponse]{ClientStream: stream}
...
type CalculatorServer interface {
	...
	GenerateFibonacci(*FibonacciReqest, grpc.ServerStreamingServer[FibonacciResponse]) error
...
func (UnimplementedCalculatorServer) GenerateFibonacci(*FibonacciReqest, grpc.ServerStreamingServer[FibonacciResponse]) error {
...
func _Calculator_GenerateFibonacci_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(FibonacciReqest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServer).GenerateFibonacci(m, &grpc.GenericServerStream[FibonacciReqest, FibonacciResponse]{ServerStream: stream})
}
